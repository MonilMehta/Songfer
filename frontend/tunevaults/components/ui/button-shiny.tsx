...
function ButtonCta({ label = "Get Access", className, children, ...props }: ButtonCtaProps) {
    return (
        <Button
            ...
            {...props}
        >
            <div className="absolute inset-0 rounded-lg p-[2px] bg-gradient-to-b from-[#654358] via-[#17092A] to-[#2F0D64] dark:opacity-100 opacity-90">
            ...
            <div className="relative flex items-center justify-center gap-2 text-white">
                {children}
                <span className="text-lg font-light bg-gradient-to-b from-[#FFFFFF] to-[#E5E5E5] dark:from-[#D69DDE] dark:to-[#B873F8] bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(199,135,246,0.4)] tracking-tighter">
                    {label}
                </span>
            </div>
